...
DATA_PATH = os.path.join(ROOT_DIR, "data", "level1", "f005_level1_data.csv")
RESULT_PATH = os.path.join(ROOT_DIR, "results", "level1", "f005_level1_results.csv")
...
def run():
    ...
    try:
        for row in rows:
            ...
            try:
                # TODO: Add Selenium steps for F005 Enroll Users
                driver.get(BASE_URL)
