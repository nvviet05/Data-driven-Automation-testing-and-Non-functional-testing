...
DATA_PATH = os.path.join(ROOT_DIR, "data", "level1", "f001_level1_data.csv")
RESULT_PATH = os.path.join(ROOT_DIR, "results", "level1", "f001_level1_results.csv")
...
def run():
    ...
    try:
        for row in rows:
            ...
            try:
                # TODO: Add Selenium steps for F001 Add New User
                driver.get(BASE_URL)
