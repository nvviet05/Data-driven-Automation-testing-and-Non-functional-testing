...
DATA_PATH = os.path.join(ROOT_DIR, "data", "level2", "f003_level2_data.csv")
RESULT_PATH = os.path.join(ROOT_DIR, "results", "level2", "f003_level2_results.csv")
...
def run():
    # TODO: Update data/level2/f003_level2_data.csv with real Moodle locators.
