...
DATA_PATH = os.path.join(ROOT_DIR, "data", "non_functional", "usability_data.csv")
RESULT_PATH = os.path.join(ROOT_DIR, "results", "non_functional", "usability_results.csv")
...
def run():
    ...
    try:
        for row in rows:
            ...
            try:
                # TODO: Check usability criteria (labels, errors, and navigation).
                driver.get(BASE_URL)
