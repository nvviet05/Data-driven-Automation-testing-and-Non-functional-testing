...
DATA_PATH = os.path.join(ROOT_DIR, "data", "non_functional", "data_integrity_data.csv")
RESULT_PATH = os.path.join(ROOT_DIR, "results", "non_functional", "data_integrity_results.csv")
...
def run():
    ...
    try:
        for row in rows:
            ...
            try:
                # TODO: Add data integrity checks (save and verify data).
                driver.get(BASE_URL)
