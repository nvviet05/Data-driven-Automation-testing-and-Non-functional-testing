...
DATA_PATH = os.path.join(ROOT_DIR, "data", "non_functional", "security_data.csv")
RESULT_PATH = os.path.join(ROOT_DIR, "results", "non_functional", "security_results.csv")
...
def run():
    ...
    try:
        for row in rows:
            ...
            try:
                # TODO: Add security checks (input validation and access control).
                driver.get(BASE_URL)
