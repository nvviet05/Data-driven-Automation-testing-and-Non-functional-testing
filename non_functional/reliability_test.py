...
DATA_PATH = os.path.join(ROOT_DIR, "data", "non_functional", "reliability_data.csv")
RESULT_PATH = os.path.join(ROOT_DIR, "results", "non_functional", "reliability_results.csv")
...
def run():
    ...
    try:
        for row in rows:
            ...
            try:
                # TODO: Add stability checks (repeat actions, session recovery).
                driver.get(BASE_URL)
